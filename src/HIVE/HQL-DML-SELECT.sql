...
load data local inpath '/home/zz/bin/hive_sets/us-covid19-counties.dat' into table t_usa_covid19;
...
from t_usa_covid19_p where count(deaths) >100 group by state; --不能使用聚合函数
